  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved instrument as @instrument" do
        post :create, {:instrument => invalid_attributes}, valid_session
        expect(assigns(:instrument)).to be_a_new(Instrument)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested instrument" do
        instrument = Instrument.create! valid_attributes
        put :update, {:id => instrument.to_param, :instrument => new_attributes}, valid_session
        instrument.reload
    ...
    context "with invalid params" do
      it "assigns the instrument as @instrument" do
        instrument = Instrument.create! valid_attributes
        put :update, {:id => instrument.to_param, :instrument => invalid_attributes}, valid_session
        expect(assigns(:instrument)).to eq(instrument)
      end
